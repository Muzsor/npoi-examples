    ...
    class Program
    {
        static void Main(string[] args)
        {
            using (XWPFDocument doc = new XWPFDocument())
            {
                ...
                r4.AppendText("No more; and by a sleep to say we end "
                ...
                r5.AppendText("When we have shuffled off this mortal coil,"
                        + "Must give us pause: there's the respect"
                        + "That makes calamity of so long life;");
                r5.AddBreak();
                r5.AppendText("For who would bear the whips and scorns of time,"
                        + "The oppressor's wrong, the proud man's contumely,");

                r5.AddBreak(BreakClear.ALL);
                r5.AppendText("The pangs of despised love, the law's delay,"
